...
export const SelectPair = ({ fetchFromUrlParams }: SelectPairProps) => {
  ...
  const [selectedNetwork, setSelectedNetwork] = useState<Network | null>(NETWORKS.find((n) => n.name === 'evmos') || null);
  ...
  return (
    <>
      ...
      {!showSelectTokenPage && !showSelectNetworkPage && (
        <>
          <Logo>
            <span>🔥</span> Forge Pool Analytics
           ...
           <Heading>Select Pair</Heading>
            ...
            <FeeTiersContainer>
              ...
              >
                ...
                <span>Best for pegged assets or stablecoin pools.</span>
              ...
              >
                ...
                <span>Best for very stable token pairs.</span>
              ...
              >
                ...
                <span>Common tier that suits the need of most pools.</span>
              ...
              >
                ...
                <span>For volatile, exotic, or pools w/ low liquidity.</span>
